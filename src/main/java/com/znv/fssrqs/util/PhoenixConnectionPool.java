...
/**
 * Created by dongzelong on  2019/6/19 17:02.
 *
 * @author dongzelong
 * @version 1.0
 * @Description TODO
...
public class PhoenixConnectionPool {
    ...
    private int initialConnections = HdfsConfigManager.getPhoenixConnPoolInt(CommonConstant.PhoenixProperties.CONNECTION_INITIAL_SIZE);
    //连接池自动增加的大小CONNECTION_INITIAL_SIZE
    private int incrementalConnections = 5;
    // 连接池最大的大小
    private int maxConnections = HdfsConfigManager.getPhoenixConnPoolInt(CommonConstant.PhoenixProperties.CONNECTION_MAX_SIZE);
    // 存放连接池中数据库连接的向量 , 初始时为 null,存放的对象为 PooledConnection 型
     ...
     * @param dbPass     String 连接数据库用户的密码
     */
    public PhoenixConnectionPool(String jdbcDriver, String dbUrl, String dbUsername, String dbPass) {
    ...
    private Connection newConnection() throws SQLException {
        ...
        // Connection conn = DriverManager.getConnection(dbUrl, props);  // lq-modify
    ...
    private void wait(int mSeconds) {
        try {
            ...
            // e.printStackTrace();
            Thread.currentThread().interrupt(); // lq-add 2018-05-28 check style
            System.out.println("数据库连接等待异常！");
